...
parser.add_argument('puesto_colaborador_calificar')
...
class Interrogante(Resource):
    ...
    def ids_interrogantes_calificadas(self):
        ...
        resultado = []
        for i in collection.find(condicion, campos):
            resultado.append(ObjectId(i['cualitativo'][0]['id_interrogante']))
    ...
    def datos_interrogante(self):
        ...
        condicion = {
            ...
            'puesto': {'$in': [' ', self.__args['puesto_colaborador_calificar']]}
        }
